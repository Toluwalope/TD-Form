...
class ProjectTimeline extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      releaseDate: this.props.data
        ? moment(this.props.data.releaseDate)
        : new Date("2021-01-01T21:11:54"),
      responseDate: this.props.data
        ? moment(this.props.data.responseDate)
        : new Date("2021-01-01T21:11:54"),
      negotiationSignOffDate: this.props.data
        ? moment(this.props.data.negotiationSignOffDate)
        : new Date("2021-01-01T21:11:54"),
      supplierCommDate: this.props.data
        ? moment(this.props.data.supplierCommDate)
        : new Date("2021-01-01T21:11:54"),
      iniPlannedNegotiationEndDate: this.props.data
        ? moment(this.props.data.iniPlannedNegotiationEndDate)
        : new Date("2021-01-01T21:11:54"),
      negotiationStartDate: this.props.data
        ? moment(this.props.data.negotiationStartDate)
        : new Date("2021-01-01T21:11:54"),
      negotiationEndDate: this.props.data
        ? moment(this.props.data.negotiationEndDate)
        : new Date("2021-01-01T21:11:54"),
    };
  }
