...
class Commitment extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      bmConducted: this.props.data ? this.props.data.bmConducted : false,
      disableOtherPenalty: this.props.data
        ? this.props.data.disableOtherPenalty
        : true,

      varBmIncluded: this.props.data ? this.props.data.varBmIncluded : false,
      bmDecisionBasis: this.props.data
        ? this.props.data.bmDecisionBasis
        : false,
      transparencyDecisionBasis: this.props.data
        ? this.props.data.transparencyDecisionBasis
        : "",
      commitmentToSetSuppliers: this.props.data
        ? this.props.data.commitmentToSetSuppliers
        : false,

      commitmentToNegotiationProcess: this.props.data
        ? this.props.data.commitmentToNegotiationProcess
        : "",
      commitmentToNegotiationOutcome: this.props.data
        ? this.props.data.commitmentToNegotiationOutcome
        : "",
      commitmentInSupplierComm: this.props.data
        ? this.props.data.commitmentInSupplierComm
        : "",
      modeSupplierComm: this.props.data ? this.props.data.modeSupplierComm : "",
      deliverySupplierComm: this.props.data
        ? this.props.data.deliverySupplierComm
        : "",
      modeNegotiationEvent: this.props.data
        ? this.props.data.modeNegotiationEvent
        : "",
      strategicImportanceForClient: this.props.data
        ? this.props.data.strategicImportanceForClient
        : "",
    };
  }
    ...
    if (this.props !== nextProps) {
      this.setState({
        ...
        commitmentInSupplierComm: this.props.data
          ? this.props.data.commitmentInSupplierComm
          : "",
        modeSupplierComm: this.props.data
          ? this.props.data.modeSupplierComm
          : "",
        deliverySupplierComm: this.props.data
          ? this.props.data.deliverySupplierComm
          : "",
          ...
          >
            <GridItem xs={10}>
              <FormControlLabel
                ...
                label={
                  <Typography style={{ fontSize: "12px" }}>
                    Variable Bonus/Penalty Included
                  </Typography>
                }
              />
            </GridItem>
          ...
          >
            <GridItem xs={10}>
              <FormControlLabel
                ...
                label={
                  <Typography style={{ fontSize: "12px" }}>
                    Bonus/Penalty Used for Decision Basis
                  </Typography>
                }
              />
            </GridItem>
          ...
          >
            <GridItem xs={10}>
              <FormControlLabel
                ...
                label={
                  <Typography style={{ fontSize: "12px" }}>
                    Commitment to Set of Suppliers
                  </Typography>
                }
              />
            </GridItem>
