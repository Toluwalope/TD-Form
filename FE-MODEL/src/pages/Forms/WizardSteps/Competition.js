                      ...
                      >
                        <GridItem xs={10}>
                          <CustomSelect
                            ...
                            value={this.state.baskets[key].averageBMScore}
                            // onChange={this.handleContractTypeChange}
                            onChange={(e) => {
                              let baskets = [...this.state.baskets]
                              baskets[key].averageBMScore = e.target.value
                              this.setState({ baskets })
                            }}
                      ...
                      >
                        <GridItem xs={10}>
                          <CustomSelect
                            ...
                            value={this.state.baskets[key].methodOfNegotiation}
                            // onChange={this.handleContractTypeChange}
                            onChange={(e) => {
                              let baskets = [...this.state.baskets]
                              baskets[key].methodOfNegotiation = e.target.value
                              this.setState({ baskets })
                            }}
