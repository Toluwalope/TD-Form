    ...
    if (this.props !== nextProps) {
      this.setState({
        ...
        otherIndustryState: this.props.data
          ...
          : "",
        projectName: this.props.data ? this.props.data.projectName : "",
        projectNameState: this.props.data
          ? this.props.data.projectNameState
          : "",
        contractType: this.props.data ? this.props.data.contractType : "",
        contractTypeState: this.props.data
          ? this.props.data.contractTypeState
        ...
        disableOtherIndustry: this.props.data
          ? this.props.data.disableOtherIndustry
          : true,
        disableOtherContractType: this.props.data
          ? this.props.data.disableOtherContractType
          : true,
        val: this.props.data ? this.props.data.val : "",
