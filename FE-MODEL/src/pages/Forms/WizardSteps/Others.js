...
class Others extends React.Component {
	constructor(props) {
		...
		this.state = {
			allocationToolUsed:
				this.props.data ? this.props.data.allocationToolUsed :
				true,
			sourcingCockpitUsed:
				this.props.data ? this.props.data.sourcingCockpitUsed :
				true,
			eAuctionPlatformUsed:
				this.props.data ? this.props.data.eAuctionPlatformUsed :
				true,
			clientTCS:
				this.props.data ? this.props.data.clientTCS :
				true,
			forwardBundling:
				this.props.data ? this.props.data.forwardBundling :
				true,
			changeManagement:
				this.props.data ? this.props.data.changeManagement :
				true,
			otherPostNomination:
				this.props.data ? this.props.data.otherPostNomination :
				true
		};
	}
	sendState() {
		...
		return (
			<GridContainer justify="center">
				<GridItem xs={12} sm={12}>
					<h4 className={classes.infoText}>Let{"'"}s complete the final stage of the form</h4>
				</GridItem>
				<GridItem xs={12} sm={5}>
					<GridContainer
						xs={12}
					...
					>
						<GridItem xs={10}>
							<FormControlLabel
								...
								label={<Typography style={{ fontSize: "12px" }}>Allocation Tool Used</Typography>}
							/>
						</GridItem>
					</GridContainer>
				</GridItem>
					...
					>
						<GridItem xs={10}>
							<FormControlLabel
								...
								label={<Typography style={{ fontSize: "12px" }}>Sourcing Cockpit Used</Typography>}
							/>
						</GridItem>
					</GridContainer>
				</GridItem>
					...
					>
						<GridItem xs={10}>
							<FormControlLabel
								...
								label={<Typography style={{ fontSize: "12px" }}>E-Auction Platform Used</Typography>}
							/>
						</GridItem>
					</GridContainer>
				</GridItem>
					...
					<Card style={{ backgroundColor: "#f2f2f2", marginTop: 50 }}>
						<CardHeader color="primary" text>
							<CardText color="default">
								<h4 className={classes.cardTitle}>Post Nomination Safeguards</h4>
							</CardText>
						</CardHeader>
						<CardContent>
							<GridItem xs={3}>
								<div className={classes.checkboxAndRadio + " " + classes.checkboxAndRadioHorizontal}>
									<FormControlLabel
										...
										label={<Typography style={{ fontSize: "12px" }}>Client TC</Typography>}
									/>
								</div>
							</GridItem>
							<GridItem xs={3}>
								<div className={classes.checkboxAndRadio + " " + classes.checkboxAndRadioHorizontal}>
									<FormControlLabel
										...
										label={<Typography style={{ fontSize: "12px" }}>Forward Bundling</Typography>}
									/>
								</div>
							</GridItem>
							<GridItem xs={3}>
								<div className={classes.checkboxAndRadio + " " + classes.checkboxAndRadioHorizontal}>
									<FormControlLabel
										...
										label={<Typography style={{ fontSize: "12px" }}>Change Management</Typography>}
									/>
								</div>
							</GridItem>
							<GridItem xs={3}>
